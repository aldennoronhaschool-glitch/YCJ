  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-white">
        ...
        <section className={`relative py-16 px-4 ${heroBackgroundImage ? '' : 'bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50'}`}>
          {heroBackgroundImage && (
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">
                      {settings.contact_address_line1 || "CSI Christha Jyothi Church"}
